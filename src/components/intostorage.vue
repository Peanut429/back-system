        ...
        <Row>
            <Col :xs="{span: 24}" :md="{span: 18}">
                <Row :gutter="16" class="selectors">
                    ...
                    <Col :xs="{span: 24}" :sm="{span: 12}" :md="{span: 6}">
                        <DatePicker type="date" @on-change="chooseDate" placeholder="入库日期"></DatePicker>
                    </Col>
                </Row>
            </Col>
    ...
    export default {
        data() {
          return {
              ...
              documentsType: [
                  {label: '全部', value: 'all'},
                  {label: '配送入库', value: 'productDistribution'}
              ],
              executor: [
                  {label: '全部', value: 'all'},
              ...
              columns: [
                  ...
                  {title: '入库时间', key: 'completeTime'},
                  {title: '入库状态', key: 'completeState'},
